...
dbWriteTable(con,c("ita","men_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ita","men_basic_factors"),as.data.frame(combined),row.names=TRUE)
...
jpeg("diagnostics/men_fitted_vs_residuals.jpg")
plot(f,r)
jpeg("diagnostics/men_q-q_plot.jpg")
