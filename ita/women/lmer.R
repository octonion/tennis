...
dbWriteTable(con,c("ita","women_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ita","women_basic_factors"),as.data.frame(combined),row.names=TRUE)
...
jpeg("diagnostics/women_fitted_vs_residuals.jpg")
plot(f,r)
jpeg("diagnostics/women_q-q_plot.jpg")
