...
drop table if exists ita.men_singles_rounds;

create table ita.men_singles_rounds (
	year				integer,
	round_id			integer,
	division_id			integer,
	player_id			integer,
...
copy ita.men_singles_rounds from '/tmp/rounds.csv' with delimiter as ',' csv header quote as '"';

-- matchup probabilities

drop table if exists ita.men_singles_matrix_p;

create table ita.men_singles_matrix_p (
	year				integer,
	player_id			integer,
	opponent_id			integer,
	player_p			float,
...
insert into ita.men_singles_matrix_p
